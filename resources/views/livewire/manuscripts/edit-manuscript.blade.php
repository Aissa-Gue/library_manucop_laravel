...
<div>
    ...
    <form wire:submit.prevent="update()" method="post">
        ...
        <div class="step-three bg-white-trans @if ($currentStep != 3) d-none @endif">
            <div class="row mt-2">
                <div class="col-md-2">
                    ...
                    <select wire:model="font" name="font" id="font"
                        ...
                        <option value="مغربي" @if (old('font') == 'مغربي') selected @endif>مغربي
                        </option>
                        <option value="مشرقي" @if (old('font') == 'مشرقي') selected @endif>مشرقي
                        </option>
                    </select>
                    @error('font')
                        <div class="invalid-feedback">
                ...
                <div class="col-md-auto">
                    ...
                    <select wire:model="transcriber_level" name="transcriber_level" id="transcriber_level"
                        ...
                        <option value="جيدة" @if (old('transcriber_level') == 'جيدة') selected @endif>جيدة
                        </option>
                        <option value="حسنة" @if (old('transcriber_level') == 'حسنة') selected @endif>حسنة
                        </option>
                        <option value="متوسطة" @if (old('transcriber_level') == 'متوسطة') selected @endif>متوسطة
                        </option>
                        <option value="رديئة" @if (old('transcriber_level') == 'رديئة') selected @endif>رديئة
                        </option>
                    </select>
            ...
            <div class="row mt-2">
                <div class="col-md-3">
                    ...
                    <select wire:model="paper_size" name="paper_size" id="paper_size"
                        ...
                        <option value="1" @if (old('paper_size') == 1) selected @endif>القطع الكبير
                        </option>
                        <option value="2" @if (old('paper_size') == 2) selected @endif>القطع المتوسط
                        </option>
                        <option value="3" @if (old('paper_size') == 3) selected @endif>القطع الصغير
                        </option>
                    </select>
                    @error('paper_size')
                        <div class="invalid-feedback">
            ...
            <div class="row mt-2">
                <div class="col-md-3">
                    ...
                    <select wire:model="regular_lines" name="regular_lines" id="regular_lines"
                        ...
                        <option value="" selected>- حدد خيار -</option>
                        <option value="1" @if (old('regular_lines') == '1') selected @endif>منتظمة
                        </option>
                        <option value="0" @if (old('regular_lines') == '0') selected @endif>غير منتظمة
                        </option>
                    </select>
                    @error('regular_lines')
                        <div class="invalid-feedback">
            ...
            <div class="row mt-2">
                <div class="col-md-3">
                    ...
                    <select wire:model="is_truncated" name="is_truncated" id="is_truncated"
                        ...
                        <option value="0" @if (old('is_truncated') == '0') selected @endif>مبتورة
                        </option>
                    </select>
                    @error('is_truncated')
                        <div class="invalid-feedback">
                ...
                <div class="col-md-4">
                    ...
                    <input wire:model="truncation_notes" type="text"
                        ...
                        id="truncation_notes" placeholder="أدخل مكان البتر" value="{{ old('truncation_notes') }}">
            ...
            <div class="row mt-2">
                ...
                <div class="col-md-3">
                    ...
                    <select wire:model="save_status" name="save_status" id="save_status"
                        ...
                        <option value="" selected>- حدد مستوى -</option>
                        <option value="حسنة" @if (old('save_status') == 'حسنة') selected @endif>حسنة
                        </option>
                        <option value="متوسطة" @if (old('save_status') == 'متوسطة') selected @endif>متوسطة
                        </option>
                        <option value="رديئة" @if (old('save_status') == 'رديئة') selected @endif>رديئة
                        </option>
                        <option value="من حسنة إلى متوسطة" @if (old('save_status') == 'من حسنة إلى متوسطة') selected @endif>
                            من حسنة إلى متوسطة
                        </option>
                        <option value="من متوسطة إلى رديئة" @if (old('save_status') == 'من متوسطة إلى رديئة') selected @endif>
                            من متوسطة إلى رديئة
                        </option>
            ...
            <div class="row mt-2">
                <div class="col-md-5">
                    ...
                    <input list="motifs" type="text" placeholder="حدد زخرفة" class="form-control multidatalist"
                        id="motif" onchange="getMotif()">
                    <datalist id="motifs">
            ...
            <div class="row mt-2">
                <div class="col-md-5">
                    ...
                    <input type="text" placeholder='حدد لون' class='form-control multidatalist' list='colors' id="color"
                        onchange="getColor()">
                    <datalist id="colors">
        ...
        <div class="step-four bg-white-trans @if ($currentStep != 4) d-none @endif">
            <div class="row mt-2">
                <div class="col-md-5">
                    ...
                    <input type="text" placeholder='حدد خيار' class='form-select multidatalist' list='manutypes'
                        id="manutype" onchange="getManutype()">
            ...
            <div class="row mt-2">
                <div class="col-md-auto">
                    ...
                    <select wire:model="manuscript_level" name="manuscript_level" id="manuscript_level"
                        ...
                        <option value="" selected>- حدد مستوى -</option>
                        <option value="جيدة" @if (old('manuscript_level') == 'جيدة') selected @endif>جيدة
                        </option>
                        <option value="حسنة" @if (old('manuscript_level') == 'حسنة') selected @endif>حسنة
                        </option>
                        <option value="متوسطة" @if (old('manuscript_level') == 'متوسطة') selected @endif>متوسطة
                        </option>
                        <option value="رديئة" @if (old('manuscript_level') == 'رديئة') selected @endif>رديئة
                        </option>
                    </select>
        ...
        <div class="action-buttons d-flex justify-content-between bg-white-trans py-2 mt-3">
            ...
            @if ($currentStep == 5)
                <button type="submit" class="btn btn-md btn-primary"><i class="fas fa-pencil-alt"></i>
                    تعديل</button>
            @endif
