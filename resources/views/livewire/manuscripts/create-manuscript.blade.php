...
<div>
    ...
    <form wire:submit.prevent="store()" method="post">
        ...
        <div class="step-one bg-white-trans @if ($currentStep != 1) d-none @endif">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type='text' placeholder='حدد اسم الناسخ'
                                class="form-control @error('transcriber1_id') is-invalid @enderror" list='transcribers1'
                            ...
                            <datalist id="transcribers1">
                                @foreach ($transcribers1 as $transcriber1)
                                    <option value="{{ $transcriber1->full_name }}"
                    ...
                    <div class="col-md-6 mt-2">
                        <div class="form-group">
                            ...
                            <input type="text" placeholder='حدد اسم الناسخ المشابه له في الخط'
                                class="form-control multidatalist @error('transcriber1_matchers') is-invalid @enderror"
                                list='fontMatchers1' wire:model="fontMatcher1" id="fontMatcher1"
                                onchange="getFontMatcher1()">

                            <datalist id="fontMatchers1">
                                @foreach ($fontMatchers1 as $fontMatcher1)
                                    <option value="{{ $fontMatcher1->full_name }}"
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type='text' placeholder='حدد اسم الناسخ'
                                class="form-control @error('transcriber2_id') is-invalid @enderror"
                                list='transcribers2' wire:model="transcriber2" id="transcriber2"
                                name="transcriber2_name" wire:change="setTranscriberId(2, transcriber2_id)">

                            <datalist id="transcribers2">
                                @foreach ($transcribers2 as $transcriber2)
                                    <option value="{{ $transcriber2->full_name }}"
                    ...
                    <div class="col-md-6 mt-2">
                        <div class="form-group">
                            <label for="fontMatcher2" class="form-label">الناسخ المشابه له في
                                الخط</label>
                            <input type="text" placeholder='حدد اسم الناسخ المشابه له في الخط'
                                class="form-control multidatalist @error('transcriber2_matchers') is-invalid @enderror"
                                list='fontMatchers2' wire:model="fontMatcher2" id="fontMatcher2"
                                onchange="getFontMatcher2()">
                            <datalist id="fontMatchers2">
                                @foreach ($fontMatchers2 as $fontMatcher2)
                                    <option value="{{ $fontMatcher2->full_name }}"
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type='text' placeholder='حدد اسم الناسخ'
                                class="form-control @error('transcriber3_id') is-invalid @enderror"
                                list='transcribers3' wire:model="transcriber3" id="transcriber3"
                                name="transcriber3_name" wire:change="setTranscriberId(3, transcriber3_id)">

                            <datalist id="transcribers3">
                                @foreach ($transcribers3 as $transcriber3)
                                    <option value="{{ $transcriber3->full_name }}"
                    ...
                    <div class="col-md-6 mt-2">
                        <div class="form-group">
                            <label for="fontMatcher3" class="form-label">الناسخ المشابه له في
                                الخط</label>
                            <input type="text" placeholder='حدد اسم الناسخ المشابه له في الخط'
                                class="form-control multidatalist @error('transcriber3_matchers') is-invalid @enderror"
                                list='fontMatchers3' wire:model="fontMatcher3" id="fontMatcher3"
                                onchange="getFontMatcher3()">
                            <datalist id="fontMatchers3">
                                @foreach ($fontMatchers3 as $fontMatcher3)
                                    <option value="{{ $fontMatcher3->full_name }}"
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type='text' placeholder='حدد اسم الناسخ'
                                class="form-control @error('transcriber4_id') is-invalid @enderror"
                                list='transcribers4' wire:model="transcriber4" id="transcriber4"
                                name="transcriber4_name" wire:change="setTranscriberId(4, transcriber4_id)">

                            <datalist id="transcribers4">
                                @foreach ($transcribers4 as $transcriber4)
                                    <option value="{{ $transcriber4->full_name }}"
                    ...
                    <div class="col-md-6 mt-2">
                        <div class="form-group">
                            <label for="fontMatcher4" class="form-label">الناسخ المشابه له في
                                الخط</label>
                            <input type="text" placeholder='حدد اسم الناسخ المشابه له في الخط'
                                class="form-control multidatalist @error('transcriber4_matchers') is-invalid @enderror"
                                list='fontMatchers4' wire:model="fontMatcher4" id="fontMatcher4"
                                onchange="getFontMatcher4()">
                            <datalist id="fontMatchers4">
                                @foreach ($fontMatchers4 as $fontMatcher4)
                                    <option value="{{ $fontMatcher4->full_name }}"
            ...
            @if ($nbrOfTranscribers < 4)
                ...
                <div class="row justify-content-md-center mt-4">
                    ...
                    <a wire:click="increaseNbrOfTranscribers()" class="col-md-auto btn btn-sm btn-primary"
        ...
        <div class="step-two bg-white-trans @if ($currentStep != 2) d-none @endif ">
            <div class="row">
                <div class="col-md-9">
                    ...
                    <input type='text' placeholder='حدد عنوان الكتاب'
                        class="form-select @error('book_id') is-invalid @enderror" list='books' wire:model="book"
                ...
                <div class="col-md-2">
                    ...
                    <input type="number" wire:model="book_part"
                        ...
                        id="book_part" placeholder="أدخل جزء الكتاب" value="{{ old('book_part') }}">
                    @error('book_part')
            ...
            <div id="transDate">
                <div class="row mt-2" id="transDate_exact">
                    <div class="col-md-2">
                        ...
                        <select wire:model="trans_day" name="trans_day" id="trans_day"
                            ...
                            @for ($i = 0; $i <= 6; $i++)
                                <option value="{{ $i + 1 }}"
                                    @if (old('trans_day') == $i + 1) selected @endif>
                                    {{ $days[$i] }}
                                </option>
                            @endfor
                        </select>
                    ...
                    <div class="col-md-2">
                        ...
                        <select wire:model="trans_day_nbr" name="trans_day_nbr" id="trans_day_nbr"
                            ...
                            @for ($i = 1; $i <= 31; $i++)
                                <option value="{{ $i }}"
                                    @if (old('trans_day_nbr') == $i) selected @endif>
                                    {{ $i }}
                                </option>
                            @endfor
                        </select>
                    ...
                    <div class="col-md-2">
                        ...
                        <select wire:model="trans_month" name="trans_month" id="trans_month"
                            ...
                            @for ($i = 0; $i <= 11; $i++)
                                <option value="{{ $i + 1 }}"
                                    @if (old('trans_month') == $i + 1) selected @endif>
                                    {{ $months[$i] }}
                                </option>
                            @endfor
                        </select>
                    ...
                    <div class="col-md-2">
                        ...
                        <input wire:model="trans_syear" type="number"
                            ...
                            id="trans_syear" placeholder="أدخل السنة" value="{{ old('trans_syear') }}">
                        @error('trans_syear')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                ...
                <div class="row" id="transDate_exact_m">
                    <div class="offset-2 col-md-2">
                        <select wire:model="trans_day_nbr_m" name="trans_day_nbr_m" id="trans_day_nbr"
                            ...
                            @for ($i = 1; $i <= 31; $i++)
                                <option value="{{ $i }}"
                                    @if (old('trans_day_nbr_m') == $i) selected @endif>
                                    {{ $i }}
                                </option>
                            @endfor
                        </select>
                    ...
                    <div class="col-md-2">
                        <select wire:model="trans_month_m" name="trans_month_m" id="trans_month"
                            ...
                            @for ($i = 0; $i <= 11; $i++)
                                <option value="{{ $i + 1 }}"
                                    @if (old('trans_month_m') == $i + 1) selected @endif>
                                    {{ $months_m[$i] }}
                                </option>
                            @endfor
                        </select>
                    ...
                    <div class="col-md-2">
                        <input wire:model="trans_syear_m" type="number"
                            ...
                            id="trans_syear_m" placeholder="أدخل السنة" value="{{ old('trans_syear_m') }}">
                        @error('trans_syear_m')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                ...
                <div class="row mt-2" id="transDate_range">
                    <div class="col-md-auto">
                        ...
                        <input wire:model="trans_syear" type="number"
                            class="form-control @error('trans_syear') is-invalid @enderror" name="trans_syear"
                            id="trans_syear" placeholder="من سنة" value="{{ old('trans_syear') }}">
                        @error('trans_syear')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="col-md-auto">
                        ...
                        <input wire:model="trans_eyear" type="number"
                            ...
                            id="trans_eyear" placeholder="إلى سنة" value="{{ old('trans_eyear') }}">
                        @error('trans_eyear')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                ...
                <div class="row" id="transDate_range_m">
                    <div class="col-md-auto">
                        <input wire:model="trans_syear_m" type="number"
                            class="form-control @error('trans_syear_m') is-invalid @enderror" name="trans_syear_m"
                            id="trans_syear_m" placeholder="من سنة" value="{{ old('trans_syear_m') }}">
                        @error('trans_syear_m')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="col-md-auto">
                        <input wire:model="trans_eyear_m" type="number"
                            ...
                            id="trans_eyear_m" placeholder="إلى سنة" value="{{ old('trans_eyear_m') }}">
                        @error('trans_eyear_m')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
            ...
            <div class="row mt-2">
                <div class="col-md-5">
                    ...
                    <input wire:model="trans_place" name="trans_place"
                        ...
                        placeholder="أدخل مكان النسخ" value="{{ old('trans_place') }}">
                    @error('trans_place')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="col-md-3">
                    ...
                    <input type='text' placeholder='حدد مدينة النسخ'
                        class="form-select @error('city_id') is-invalid @enderror" list='cities' wire:model="city"
                ...
                <div class="col-md-3">
                    ...
                    <input type='text' class="form-select @error('country_id') is-invalid @enderror"
                        placeholder="حدد بلد النسخ" id="country" list="countries" wire:model="country"
                        name="country_name" wire:change="setCountryId(country_id)">
            ...
            <div class="row mt-2">
                <div class="col-md-3">
                    ...
                    <select wire:model="signed_in" name="signed_in" id="signed_in"
                        ...
                        <option value="0" @if (old('signed_in') == '0') selected @endif>بالمقارنة
                        </option>
                    </select>
                    @error('signed_in')
                        <div class="invalid-feedback">
                ...
                <div class="col-md-3">
                    ...
                    <input wire:model="nbr_in_index" name="nbr_in_index"
                        ...
                        type="number" placeholder="أدخل الرقم في الفهرس" value="{{ old('nbr_in_index') }}">
                    @error('nbr_in_index')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
            ...
            <div class="row mt-2">
                <div class="col-md-7">
                    ...
                    <input type='text' placeholder='حدد اسم الخزانة'
                        class="form-select @error('cabinet_id') is-invalid @enderror" list='cabinets'
                ...
                <div class="col-md-auto">
                    ...
                    <select wire:model="manu_type" name="manu_type" id="manu_type"
                        ...
                        <option value="دغ" @if (old('manu_type') == 'دغ') selected @endif>دون غلاف
                        </option>
                    </select>
                    @error('manu_type')
                        <div class="invalid-feedback">
        ...
        <div class="step-three bg-white-trans @if ($currentStep != 3) d-none @endif p-2">
            <div class="row mt-2">
                <div class="col-md-3">
                ...
                <div class="col-md-auto">
                    ...
                    <select wire:model="transcriber_level" name="transcriber_level" id="transcriber_level"
                        ...
                        <option value="متوسطة" @if (old('transcriber_level') == 'متوسطة') selected @endif>متوسطة
                        </option>
            ...
            <div class="row mt-2">
                ...
                <div class="col-md-4">
                    ...
                    <input wire:model="size_notes" type="text"
                        ...
                        id="size_notes" placeholder="أدخل ملاحظات المقاس" value="{{ old('size_notes') }}">
                    @error('size_notes')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
            ...
            <div class="row mt-2">
                ...
                <div class="col-md-4">
                    ...
                    <input wire:model="lines_notes" type="text"
                        ...
                        id="lines_notes" placeholder="أدخل ملاحظات المسطرة" value="{{ old('lines_notes') }}">
                    @error('lines_notes')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
            ...
            <div class="row mt-2">
                <div class="col-md-5">
                    <div class="form-group">
                        ...
                        <input wire:model="manutype" type="text" placeholder='حدد خيار'
                            class='form-select multidatalist' list='manutypes' id="manutype" onchange="getManutype()">
            ...
            <div class="row mt-2">
                <div class="col-md-auto">
                    ...
                    <select wire:model="manuscript_level" name="manuscript_level" id="manuscript_level"
                        ...
                        <option value="متوسطة" @if (old('manuscript_level') == 'متوسطة') selected @endif>متوسطة
                        </option>
            ...
            <div class="row mt-2">
                <div class="col-md-8">
                    ...
                    <input wire:model="transcribed_to" type="text"
                        class="form-control @error('transcribed_to') is-invalid @enderror" name="transcribed_to"
                        id="transcribed_to" placeholder="أدخل المنسوخ له بأوصافه"
            ...
            <div class="row mt-2">
                <div class="col-md-7">
                    ...
                    <textarea wire:model="notes" class="form-control @error('notes') is-invalid @enderror" name="notes" id="notes"
                        rows="3" placeholder="أدخل ملاحظات أخرى">{{ old('notes') }}</textarea>
                    @error('notes')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
        ...
        <div class="action-buttons d-flex justify-content-between bg-white-trans py-2 mt-3">
            ...
            @if ($currentStep == 5)
                <button type="submit" class="btn btn-md btn-success"><i class="fas fa-plus"></i>
                    إضافة</button>
            @endif
        </div>
