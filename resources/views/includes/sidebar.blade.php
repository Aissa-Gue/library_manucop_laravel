...
<div class="my_fixed_sidebar" style="background-color: rgba(255,255,255,0.4)">
    <div class="nav flex-column nav-pills" id="myTab" role="tablist" aria-orientation="vertical">
        ...
        <a class="nav-link {{Request::is('countries') || Request::is('cities') ? 'active' : ''}}"
        ...
        <a class="nav-link {{Route::is('authors.create') || Route::is('books.create') && (!Request::is('authors/*') || !Request::is('books/*')) ? 'active' : ''}}"
        ...
        <a class="nav-link {{Request::is('authors') || Request::is('authors/*') && !Route::is('authors.create') ? 'active' : ''}}"
        ...
        <a class="nav-link {{Request::is('books') || Request::is('books/*') && !Route::is('books.create') ? 'active' : ''}}"
        ...
        <!-- END Books/Authors section -->

        <!-- START copiers section -->
        <li class="my_navList">النساخ</li>

        <a class="nav-link {{Route::is('transcribers.create') ? 'active' : ''}}"
           href="{{Route('transcribers.create')}}">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
        ...
        <a class="nav-link {{Request::is('transcribers') || Request::is('transcribers/*') && !Route::is('transcribers.create') ? 'active' : ''}}"
           href="{{Route('transcribers.index')}}">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-people"
                 viewBox="0 0 16 16">
                <path
                    d="M15 14s1 0 1-1-1-4-5-4-5 3-5 4 1 1 1 1h8zm-7.978-1A.261.261 0 0 1 7 12.996c.001-.264.167-1.03.76-1.72C8.312 10.629 9.282 10 11 10c1.717 0 2.687.63 3.24 1.276.593.69.758 1.457.76 1.72l-.008.002a.274.274 0 0 1-.014.002H7.022zM11 7a2 2 0 1 0 0-4 2 2 0 0 0 0 4zm3-2a3 3 0 1 1-6 0 3 3 0 0 1 6 0zM6.936 9.28a5.88 5.88 0 0 0-1.23-.247A7.35 7.35 0 0 0 5 9c-4 0-5 3-5 4 0 .667.333 1 1 1h4.216A2.238 2.238 0 0 1 5 13c0-1.01.377-2.042 1.09-2.904.243-.294.526-.569.846-.816zM4.92 10A5.493 5.493 0 0 0 4 13H1c0-.26.164-1.03.76-1.724.545-.636 1.492-1.256 3.16-1.275zM1.5 5.5a3 3 0 1 1 6 0 3 3 0 0 1-6 0zm3-2a2 2 0 1 0 0 4 2 2 0 0 0 0-4z"/>
        ...
        <a class="nav-link {{Route::is('manuscripts.create') ? 'active' : ''}}" href="{{Route('manuscripts.create')}}">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
        ...
        <a class="nav-link {{Request::is('manuscripts/*') && !Route::is('manuscripts.create') ? 'active' : ''}}"
