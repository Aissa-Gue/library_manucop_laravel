...
<div class="my_fixed_sidebar" style="background-color: rgba(255,255,255,0.4)">
    <div class="nav flex-column nav-pills" id="myTab" role="tablist" aria-orientation="vertical">
        ...
        <a class="nav-link {{ Route::is('authors.index') || (Request::is('authors/*') && !Route::is('authors.create')) ? 'active' : '' }}"
        ...
        <a class="nav-link {{ Route::is('transcribers.index') || (Request::is('transcribers/*') && !Route::is('transcribers.create'))? 'active': '' }}"
        ...
        <a class="nav-link {{ Route::is('manuscripts.create') ? 'active' : '' }}"
        ...
        <a class="nav-link {{ Route::is('manuscripts.index') || (Request::is('manuscripts/*') && !Route::is('manuscripts.create'))? 'active': '' }}"
