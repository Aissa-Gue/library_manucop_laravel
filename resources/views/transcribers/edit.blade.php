    ...
    <form action="{{Route('transcribers.update', $transcriber->id)}}" method="post">
        ...
        <fieldset class="scheduler-border">
            ...
            <div class="row mt-2">
                ...
                @if($transcriber->descent2 != null)
                    ...
                    <div class="col-md-2">
                        ...
                        <input name="descent2" class="form-control @error('descent2') is-invalid @enderror"
                               id="descent2"
                ...
                @if($transcriber->descent3 != null)
                    ...
                    <div class="col-md-2">
                        ...
                        <input name="descent3" class="form-control @error('descent3') is-invalid @enderror"
                               id="descent3"
                ...
                @if($transcriber->descent4 != null)
                    ...
                    <div class="col-md-2">
                        ...
                        <input name="descent4" class="form-control @error('descent4') is-invalid @enderror"
                               id="descent4"
                ...
                @if($transcriber->descent5 != null)
                    <script>var a = 6</script>
                    <div class="col-md-2">
                        <label for="descent5" class="form-label">النسبة</label>
                        <input name="descent5" class="form-control @error('descent5') is-invalid @enderror"
                               id="descent5"
            ...
            <div class="row mt-2">
                ...
                <div class="col-md-2">
                    ...
                    @else
                        <script>
                            $(document).ready(function () {
                                $('#country').val({{$transcriber->country_id}});
                                $('#country').trigger('change');
                            });
                        </script>
                    @endif
            ...
            <div class="row justify-content-end text-end">
                <div class="col-md-2">
                    <button type="submit" class="btn btn-primary">تعديل الناسخ</button>
                </div>
            </div>
        </fieldset>
    </form>
