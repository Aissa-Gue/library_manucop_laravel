        ...
        <fieldset class="scheduler-border">
            ...
            <div class="row justify-content-md-center mb-4">
                <div class="input-group">
                    ...
                    <input type="text" name="id" class="form-control" placeholder="أدخل رقم الناسخ"
                        value="{{ request('id') }}">

                    <div class="input-group-prepend">
                        <span class="input-group-text">اسم الناسخ</span>
                    </div>
                    <input type="text" name="full_name" class="form-control" placeholder="أدخل اسم الناسخ"
            ...
            <tbody>
                ...
                @foreach ($transcribers as $transcriber)
                    <tr>
                        ...
                        <td class="text-center">
                            <a class="btn btn-outline-success" href="{{ Route('transcribers.show', $transcriber->id) }}">
                                <i class="fas fa-eye"></i>
                            </a>
                        </td>

                        <td class="text-center">
                            <a class="btn btn-outline-primary" href="{{ Route('transcribers.edit', $transcriber->id) }}">
