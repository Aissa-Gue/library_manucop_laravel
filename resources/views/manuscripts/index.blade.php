        ...
        <fieldset class="scheduler-border">
            ...
            <div class="row justify-content-md-center mb-4">
                <div class="input-group">
                    ...
                    <input type="text" name="id" class="form-control" placeholder="أدخل رقم الاستمارة"
                        value="{{ request('id') }}">
            ...
            <tbody>
                ...
                @foreach ($manuscripts as $manuscript)
                    <tr>
                        ...
                        <td class="text-center">
                            <a class="btn btn-outline-success" href="{{ Route('manuscripts.show', $manuscript->id) }}">
                                <i class="fas fa-eye"></i>
                            </a>
                        </td>

                        <td class="text-center">
                            <a class="btn btn-outline-primary" href="{{ Route('manuscripts.edit', $manuscript->id) }}">
