        ...
        <fieldset class="scheduler-border">
            ...
            <div class="row">
                <div class="col-md-7">
                    ...
                    <input name="name" class="form-control @error('name') is-invalid @enderror" id="author" value="{{old('name') ?? $author->name}}"
            ...
            <div class="row justify-content-end text-end">
                <div class="col-md-2">
                    <button type="submit" class="btn btn-primary">تعديل المؤلف</button>
                </div>
            </div>
        </fieldset>
    </form>
