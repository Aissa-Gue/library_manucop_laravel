<div class="modal fade" id="editCity{{ $city->id }}" data-bs-backdrop="static" data-bs-keyboard="false"
    tabindex="-1" aria-labelledby="editCity" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p class="mb-2">البلد:
                    <strong class="text-success">{{ $city->country->name }}</strong>
                </p>
