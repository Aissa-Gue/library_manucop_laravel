...
class TranscriberSearch extends Component
{
    ...
    {
        return $fontMatchers = Transcriber::where('full_name', 'LIKE', '%' . $this->fontMatcher1 . '%')->paginate(20);
    }
    public function fontMatchers2()
    {
        return $fontMatchers = Transcriber::where('full_name', 'LIKE', '%' . $this->fontMatcher2 . '%')->paginate(20);
    }
    public function fontMatchers3()
    {
        return $fontMatchers = Transcriber::where('full_name', 'LIKE', '%' . $this->fontMatcher3 . '%')->paginate(20);
    }
    public function fontMatchers4()
    {
        return $fontMatchers = Transcriber::where('full_name', 'LIKE', '%' . $this->fontMatcher4 . '%')->paginate(20);
    }
